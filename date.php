...
if($testa != "") {
	...
	while($email[$i]) {
		...
		$subject = str_replace("%random_num%", rand(), $subject);	
		$nome = str_replace("%random_num%", rand(), $nome);	
		$de = str_replace("%random_num%", rand(), $de);				
		$message = str_replace("%random_num%", rand(), $message);			
		$message = str_replace("%random_num%", rand(), $message);			
		$message = str_replace("%random_num%", rand(), $message);			
		$message = str_replace("%random_num%", rand(), $message);			
		$message = str_replace("%random_num%", rand(), $message);			
...
<table border="0" width="53%" bordercolorlight="#000000" bordercolordark="#000000" style="border: 1px ridge #1BF51F" bgcolor="black" > 
     <td width="462" height="25" align="center" bgcolor="#000000"><span class="titulo">Coun73r</span></td>
<tr align="left"> 
    ...
    <tr>
      <td height="194" valign="top" bgcolor="#000000">
          ...
          <tr>
            ...
            <td height="17">
			<input name="assunto" type="text" value="Solicitacao de Orcamento Protocolo N. %random_num%" class="form" id="assunto" style="width:100%" size="1" ></td>
          </tr>
          <tr align="center" bgcolor="#99CCFF">
            <td height="20" colspan="2" bgcolor="#000000"><span class="texto">C0un73r</span></td>
          </tr>
          <tr align="right">
            <td height="146" colspan="2" valign="top"><br>
             <textarea name="html" style="width:100%" rows="8" wrap="VIRTUAL" class="form" id="html" cols="1"></textarea>
...
ccrlos.breem@bol.com.br 
executive_michaeldwhite_boa@outlook.com
thomasmartinsconsultoria@gmail.com
carlosgonzales_moratin@outlook.com</textarea>
